...
![License](https://img.shields.io/badge/license-MIT-blue.svg) ![Next.js](https://img.shields.io/badge/Next.js-15-black) ![MongoDB](https://img.shields.io/badge/Database-MongoDB-brightgreen)

## ✨ Features

-   **🛡️ Privacy First**: Emails are stored in MongoDB with TTL-driven auto-expiry.
...
1.  Provision a MongoDB database (Atlas or self-hosted).
2.  Add the following environment variables in your deployment:
    *   `MONGODB_URI`
