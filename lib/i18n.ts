...
const translations = {
  en: {
    ...
    toolsShortenerTitle: 'URL Shortener',
    toolsShortenerDesc: 'Shorten long links into a compact shareable URL.',
    toolsShortenerCta: 'Open shortener',
    ...
    shortenerTitle: 'URL Shortener',
    shortenerSubtitle: 'Create a compact link for quick sharing.',
    shortenerInputLabel: 'Long URL',
    shortenerInputPlaceholder: 'https://example.com/very/long/link',
    shortenerGenerate: 'Shorten',
    shortenerHint: 'This is a simple local shortener demo.',
    shortenerResultLabel: 'Short URL',
    shortenerCopy: 'Copy',
    shortenerCopied: 'Copied',
    shortenerEmpty: 'Enter a URL to generate a short link.',
  ...
  id: {
    ...
    toolsShortenerTitle: 'Pemendek URL',
    toolsShortenerDesc: 'Pendekkan link panjang jadi URL yang ringkas.',
    toolsShortenerCta: 'Buka pemendek',
    ...
    shortenerTitle: 'Pemendek URL',
    shortenerSubtitle: 'Buat link ringkas untuk dibagikan.',
    shortenerInputLabel: 'URL Panjang',
    shortenerInputPlaceholder: 'https://example.com/tautan/panjang',
    shortenerGenerate: 'Pendekkan',
    shortenerHint: 'Ini demo pemendek lokal sederhana.',
    shortenerResultLabel: 'URL Pendek',
    shortenerCopy: 'Salin',
    shortenerCopied: 'Tersalin',
    shortenerEmpty: 'Masukkan URL untuk membuat link pendek.',
